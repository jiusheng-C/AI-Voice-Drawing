...
6. 在开发调试文本框中依次输入：
   ...
   - `把它改成绿色`
   - `撤销`
7. 画布应依次出现蓝色圆形、红色矩形，最近对象变为绿色，撤销后回到上一步。
8. 点击 Start voice / Stop voice 可走 mock 语音链路，收到识别文本、命令计划和语音反馈文本。
9. 打开模型中心，可以查看并选择 ASR、NLU/LLM、TTS 模型模式。
10. 使用画布工具栏的 PNG 导出当前画布。
